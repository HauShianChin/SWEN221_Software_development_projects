...
/**
 * This represents the Card class. A card in a card game
 * @author hau shian
 *
 */
public class Card implements Comparable<Card>, Serializable {//needs to be Serializable in order to be deep cloned
	...
	public int compareTo(Card o) {
		//same suits then there can't be a repeated number
